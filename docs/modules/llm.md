...
`llm.model` · `fast_model` · `strong_model` | the three cascade slots; `strong_model` is reached only by the Text-to-SQL guard repair (ADR-0005 explains why there is no confidence gate) |
